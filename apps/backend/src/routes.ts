...
router.put("/profile", async (req, res, next) => {
  try {
    ...
    const data = {
      ...
      ...(body.preferredName !== undefined ? { preferred_name: body.preferredName } : {}),
      ...(body.email !== undefined ? { email: body.email } : {}),
      ...(body.phone !== undefined ? { phone: body.phone } : {}),
      ...(body.location !== undefined ? { location: body.location } : {}),
      ...(body.streetAddress !== undefined ? { street_address: body.streetAddress } : {}),
      ...(body.city !== undefined ? { city: body.city } : {}),
      ...(body.stateRegion !== undefined ? { state_region: body.stateRegion } : {}),
      ...
      ...(body.workAuthorization !== undefined ? { work_authorization: body.workAuthorization } : {}),
      ...(body.sponsorshipRequired !== undefined ? { sponsorship_required: body.sponsorshipRequired } : {}),
      ...(body.dateOfBirth !== undefined ? { date_of_birth: body.dateOfBirth } : {}),
      ...(body.gender !== undefined ? { gender: body.gender } : {}),
      ...(body.genderIdentity !== undefined ? { gender_identity: body.genderIdentity } : {}),
      ...(body.pronouns !== undefined ? { pronouns: body.pronouns } : {}),
      ...(body.raceEthnicity !== undefined ? { race_ethnicity: body.raceEthnicity } : {}),
      ...(body.disabilityStatus !== undefined ? { disability_status: body.disabilityStatus } : {}),
      ...(body.veteranStatus !== undefined ? { veteran_status: body.veteranStatus } : {}),
      updated_at: new Date(),
    };
